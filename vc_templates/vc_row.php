...
// Anchor tag for row by ThemeMount
if ( ! empty( $anchor ) ) {
...
if ( ! empty( $equal_height ) ) {
	$flex_row = true;
	$css_classes[] = ' vc_row-o-equal-height';
	$thememount_equalheight = 'vc_row vc_row-o-equal-height vc_row-flex'; // set classes for equal height option by ThemeMount
}
...
$output .= '<div class="section clearfix grid_section '.$thememount_equalheight.'">'; // Added by ThemeMount
